...
DOCUMENTATION = """
---
module: hv_users_facts
short_description: Get all the users of VSP One Object
description:
...
EXAMPLES = """
- name: Get information of the current user.
  hitachivantara.vspone_object.oneobject_node.hv_users_facts:
    connection_info:
...
ansible_facts:
    description: >
        Dictionary containing the discovered properties of the user.
    returned: always
    type: dict
    contains:
        user_info:
            ...
            contains:
                ...
                roles:
                    ...
                    type: list
                    sample: ["mapi:kmip:get_server", "mapi:certificates:get"]
"""
...
from ansible_collections.hitachivantara.vspone_object.plugins.module_utils.oneobject_node.params_oo import (
    OOConnectionInfoParam, Tokens, UserParam
)
