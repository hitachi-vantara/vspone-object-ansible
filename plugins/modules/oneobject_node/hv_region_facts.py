...
DOCUMENTATION = """
---
module: hv_region_facts
short_description: Get the region info of VSP One Object
description:
  - This module queries the region info from Hitachi VSP One Object.
version_added: '1.0.0'
author:
...
- name: Get region info
  hitachivantara.vspone_object.oneobject_node.hv_region_facts:
    connection_info:
...
ansible_facts:
    ...
    contains:
        region_info:
            description: Region information of the Hitachi VSP One Object system.
            type: dict
            contains:
                id:
                    description: The ID of the MAPI region.
                    type: int
                    sample: 1
                name:
...
from ansible_collections.hitachivantara.vspone_object.plugins.module_utils.oneobject_node.params_oo import (
    OOConnectionInfoParam, Tokens, RegionParam
)
from ansible_collections.hitachivantara.vspone_object.plugins.module_utils.oneobject_node.gateway_oo import (
    OOGateway,
)
from ansible_collections.hitachivantara.vspone_object.plugins.module_utils.oneobject_node.region import (
    RegionResource,
)
...
def main():
    ...
    logger.writeDebug(
        "region_param={}".format(region_param)
    )
    raw_message = ""
    try:
